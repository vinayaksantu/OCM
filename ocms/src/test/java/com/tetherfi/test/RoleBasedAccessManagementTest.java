...
public class RoleBasedAccessManagementTest extends BaseTest {
	...
	public void VerifyPageBasedUserAccess() throws Exception
	{
		...
		screenshot.captureScreen("RoleBasedAccessManagementTest","VerifyPageBasedUserAccess");
	...
	{ 
		...
		screenshot.captureScreen("RoleBasedAccessManagementTest","VerifyAccessCheckBox");
		Assert.assertTrue(RoleBasedAccessManagementWMCPage.verifyclosebutton());
	}
	...
	public void searchPage() throws Exception {
		...
		screenshot.captureScreen("RoleBasedAccessManagementTest", "clearall");
	...
	public void ClearSearch() throws Exception {
		...
		screenshot.captureScreen("RoleBasedAccessManagementTest","Invalid Search");
	...
	public void GroupBy()
	{
		...
		screenshot.captureScreen("RoleBasedAccessManagementTest","GroupBy");
		Assert.assertTrue(RoleBasedAccessManagementWMCPage.groupby());
	}
