...
public class ChatTemplatesTest extends BaseTest {
	...
	@BeforeClass
	public void NavigateToChatTemplatesPage() throws  Exception {
	...
	public void AddDuplicateDepartmentRecord() throws Exception {
		...
		Assert.assertEquals(ChatTemplatesPage.getMessage(),"Record Creation Failed, Already Exist");
	}

	@Test(priority=13,groups= {"OCM"},enabled=false)//,dependsOnMethods ="AddNewDepartmentRecord")
	...
	public void AddEmptyDepartmentRecord() throws Exception {
		String filePath = System.getProperty("user.dir")+"\\src\\test\\resources\\TestData\\ChatTemplatesData.xlsx";
		Map<String, String> map = new ExcelReader(filePath,"CreateDepartment").getTestData().get(0);
		ChatTemplateDetails ChatTemplatesDetails = new ChatTemplateDetails(map);
		ChatTemplatesPage ChatTemplatesPage = PageFactory.createPageInstance(driver, ChatTemplatesPage.class);
		...
		Assert.assertEquals(ChatTemplatesPage.getMessage(),"Please Provide Name, Enabled, Channel, OrgUnit", "Add invalid record assertion failed");
	}
	...
	public void AddRecordWithoutDepartment() throws Exception {
		...
		Assert.assertEquals(ChatTemplatesPage.getMessage(),"Please Provide Name", "Add invalid record assertion failed");
	}
	...
	public void AddRecordWithoutEnabled() throws Exception {
		...
		Assert.assertEquals(ChatTemplatesPage.getMessage(),"Please Provide Enabled", "Add invalid record assertion failed");
	}
	...
	public void AddRecordWithoutChannel() throws Exception {
		...
		Assert.assertEquals(ChatTemplatesPage.getMessage(),"Please Provide Channel", "Add invalid record assertion failed");
	}
	...
	public void AddDuplicateGroupsRecord() throws Exception {
		...
		Assert.assertEquals(ChatTemplatesPage.getMessage(),"Duplicate Name");
	}

	@Test(priority=21,groups= {"OCM"},enabled=false)//,dependsOnMethods ="AddNewGroupsRecord")
	...
	public void AddEmptyGroupRecord() throws Exception {
		String filePath = System.getProperty("user.dir")+"\\src\\test\\resources\\TestData\\ChatTemplatesData.xlsx";
		Map<String, String> map = new ExcelReader(filePath,"CreateGroup").getTestData().get(0);
		ChatTemplateDetails ChatTemplatesDetails = new ChatTemplateDetails(map);
		ChatTemplatesPage ChatTemplatesPage = PageFactory.createPageInstance(driver, ChatTemplatesPage.class);
		...
		Assert.assertEquals(ChatTemplatesPage.getMessage(),"Please Provide Department Name, Name, Enabled", "Add invalid record assertion failed");
	}
	...
	public void AddRecordWithoutDepartmentName() throws Exception {
		...
		Assert.assertEquals(ChatTemplatesPage.getMessage(),"Please Provide Department Name", "Add invalid record assertion failed");
	}
	...
	public void AddDuplicateChatTemplatesRecord() throws Exception {
		...
		Assert.assertEquals(ChatTemplatesPage.getMessage(),"Duplicate record. Department Name, Group Name,Name combination should be unique.");
	}

	@Test(priority=29,groups= {"OCM"},enabled=false)//,dependsOnMethods ="AddNewChatTemplatesRecord")
	...
	public void AddEmptyChatTemplateRecord() throws Exception {
		String filePath = System.getProperty("user.dir")+"\\src\\test\\resources\\TestData\\ChatTemplatesData.xlsx";
		Map<String, String> map = new ExcelReader(filePath,"Create").getTestData().get(0);
		ChatTemplateDetails ChatTemplatesDetails = new ChatTemplateDetails(map);
		ChatTemplatesPage ChatTemplatesPage = PageFactory.createPageInstance(driver, ChatTemplatesPage.class);
		ChatTemplatesPage.addNewEmptyChatTemplateRecord(ChatTemplatesDetails);
		Assert.assertEquals(ChatTemplatesPage.getMessage(),"Please Provide Department Name, Group Name, Name, Enabled, Text, Start Time, End Time", "Add invalid record assertion failed");
	}
	...
	public void AddRecordWithoutChatDepartmentName() throws Exception {
		...
		Assert.assertEquals(ChatTemplatesPage.getMessage(),"Please Provide Department Name, Group Name", "Add invalid record assertion failed");
	}
	...
	public void AddRecordWithoutGroupsName() throws Exception {
		...
		Assert.assertEquals(ChatTemplatesPage.getMessage(),"Please Provide Group Name", "Add invalid record assertion failed");
	}
	...
	public void AddRecordWithoutText() throws Exception {
		...
		Assert.assertEquals(ChatTemplatesPage.getMessage(),"Please Provide Text", "Add invalid record assertion failed");
	}
	...
	public void AddRecordWithoutStartTime() throws Exception {
		...
		Assert.assertEquals(ChatTemplatesPage.getMessage(),"Please Provide Start Time", "Add invalid record assertion failed");
	}
	...
	public void AddRecordWithoutEndTime() throws Exception {
		...
		Assert.assertEquals(ChatTemplatesPage.getMessage(),"Please Provide End Time", "Add invalid record assertion failed");
	}
	...
	@Test(priority=71,groups= {"OCM"},enabled=false,dependsOnMethods="EditChatTemplatesRecord")
	...
	public void EditWithoutModifyReasonRecord() throws Exception {
		...
		Assert.assertEquals(chatTemplatePage.getMessage(),"Please enter the modify reason", "empty modify reason record assertion failed");
	}
	...
	@Test(priority=75,groups= {"OCM"},enabled=false)//,dependsOnMethods="EditGroupRecord")
	...
	@Test(priority=81,groups= {"OCM"},enabled=false)//,dependsOnMethods="EditDepartmentRecord")
	...
	public void searchDepartmentwithoutSearchTextbox() throws Exception {
		ChatTemplatesPage chatTemplatesPage = PageFactory.createPageInstance(driver,ChatTemplatesPage.class);
		chatTemplatesPage.navigateToTab("Departments");
		chatTemplatesPage.searchwithoutextsearch();
		Assert.assertEquals(chatTemplatesPage.getMessage(),"Please enter the text to search or remove the filter", "Add invalid record assertion failed");
	}
	...
	public void searchGroupwithoutSearchTextbox() throws Exception {
		ChatTemplatesPage chatTemplatesPage = PageFactory.createPageInstance(driver,ChatTemplatesPage.class);
	...
	public void DeleteWithoutDeleteReasonRecord() throws Exception {
		...
		Assert.assertEquals(chatTemplatesPage.getMessage(),"Please enter the delete reason","empty delete reason record assertion failed");
	}
	...
	@Test(priority=95,groups= {"OCM"},enabled=false)//,dependsOnMethods= {"DeleteChatTemplatesRecord"})
	...
	@Test(priority=99,groups= {"OCM"},enabled=false)//,dependsOnMethods= {"DeleteGroupRecord"})
	...
	@Test(priority=104,groups= {"OCM"},enabled=false,dependsOnMethods= {"DeleteDepartmentRecord"})
	...
	public void close(Method method){
		Screenshot screenshot=new Screenshot(driver);
		screenshot.captureScreen("ChatTemplateTest",method.getName());
