...
public class OCMAgentAverageReportPage extends BasePage  {

	public OCMAgentAverageReportPage(WebDriver driver) {
		super(driver);
	}
	...
	public boolean verifyExportToExcel(String filePath) {
		...
		for (final File f : folder.listFiles()) {
			if (f.getName().startsWith("OCMAgentSurveyPerformanceReport")) {
				f.delete();
			}
		}
		selectWebElement(exporttoexcel);
		...
		Boolean Status=verifyExportPageFileDownload(filePath, "OCMAgentSurveyPerformanceReport");
		return Status;
	}
	...
	public boolean verifyDatabase(String query,ReportDetails details) throws InterruptedException {
		...
		String noOfDays1=details.getStartDate();
		String noOfDays2=details.getEndDate();
...
//		To Calculate the number of days (3600*24)
		noOfDays1=noOfDays1.substring(6,10)+"-"+noOfDays1.substring(3, 5)+"-"+noOfDays1.substring(0, 2)+" "+noOfDays1.substring(11, 13)+":"+noOfDays1.substring(14, 16)+":"+noOfDays1.substring(17, 19);
		noOfDays2=noOfDays2.substring(6,10)+"-"+noOfDays2.substring(3, 5)+"-"+noOfDays2.substring(0, 2)+" "+noOfDays2.substring(11, 13)+":"+noOfDays2.substring(14, 16)+":"+noOfDays2.substring(17, 19);	
...
//		Replace identifier no/ of days 1 and 2 in query
		query=query.replaceAll("NoOfDays1", noOfDays1);
		query=query.replaceAll("NoOfDays2", noOfDays2);
