...
public class OCMFaceAuthReportPage extends BasePage{

	public OCMFaceAuthReportPage(WebDriver driver) {
		super(driver);}
	...
	@FindBy(xpath="//a[text()='Originator']")
	...
	private WebElement groupbyOriginator;
	...
	public boolean verifyAdvanceSearchIsEqualTo(ReportDetails reportDetails) throws Exception {
		...
		{
			System.out.println(map1.get("Originator"));
			if(map1.get("Originator").equalsIgnoreCase(reportDetails.getSearchStr()))
				Status= true;
			else 
				Status =false;
		}
	...
	public boolean verifyAdvanceSearchContains(ReportDetails reportDetails) throws Exception {
		...
		{
			System.out.println(map1.get("Originator"));
			if(map1.get("Originator").toLowerCase().contains(reportDetails.getSearchStr()))				
				Status= true;
			else 
				Status =false;
		}
	...
	public boolean verifyAdvanceSearchDoesNotContains(ReportDetails reportDetails) throws Exception {
		...
		{
			System.out.println(map1.get("Originator"));
			if(!map1.get("Originator").toUpperCase().contains(reportDetails.getSearchStr()))				
				Status= true;
			else 
				Status =false;
		}
	...
	public boolean verifyAdvanceSearchStartsWith(ReportDetails reportDetails) throws Exception {
		...
		{
			System.out.println(map1.get("Originator"));
			if(!map1.get("Originator").toLowerCase().startsWith(reportDetails.getSearchStr()))				
				Status= true;
			else 
				Status =false;
		}
	...
	public boolean verifyAdvanceSearchEndsWith(ReportDetails reportDetails) throws Exception {
		...
		{
			System.out.println(map1.get("Originator"));
			if(!map1.get("Originator").toLowerCase().endsWith(reportDetails.getSearchStr()))				
				Status= true;
			else 
				Status =false;
		}
	...
	public Boolean advancedSearchANDCriteria(ReportDetails details) throws Exception {
		...
		Thread.sleep(2000);
		selectDropdownFromVisibleText(searchColListBoxAdvSrchReportPage,"Originator");
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		selectDropdownFromVisibleText(searchColListBoxAdvSrchReportPage1,"ResultReason");
		Thread.sleep(2000);
	...
	public Boolean advancedSearchORCriteria(ReportDetails details) throws Exception {
		...
		selectWebElement(searchColDropdownAdvSrchReportPage1);
		Thread.sleep(2000);
		selectDropdownFromVisibleText(searchColListBoxAdvSrchReportPage1,"Result");
		Thread.sleep(2000);
		selectWebElement(searchCriteriaDropdownAdvSrch1);
		...
		{
			if(rowdata.getText().equals(details.getSearchStr())||rowdata2.getText().contains(details.getSearchStr2()))
				Status=true;
		}
		return Status;	
	}
	...
	public boolean verifySearchByTextbox(ReportDetails details) throws Exception{	
		...
		for (Map<String,String> map1: UI)
		{   	
			if(map1.get("Originator").equals(details.getSearchStr()))
				Status= true;
			else 
				Status= false;
		}
	...
	public boolean verifySearchIsEqualTo(String details) throws Exception {
		...
		selectDropdownFromVisibleText(searchColListBox,"Originator");  
		waitForJqueryLoad(driver);
		...
		for (Map<String,String> map1: UI)
		{   	
			if(map1.get("Originator").equals(details))
				Status= true;
			else 
				Status= false;
		}
	...
	public boolean verifySearchContains(String description) throws Exception {
		...
		for (Map<String,String> map1: UI)
		{   	
			if(map1.get("Originator").toUpperCase().contains(description.toUpperCase()))
				Status= true;
			else 
				Status= false;
		}
	...
	public boolean verifySearchDoesNotContains(String description) throws Exception {
		...
		for (Map<String,String> map1: UI)
		{   	
			if(!map1.get("Originator").toLowerCase().contains(description.toLowerCase()))
				Status= true;
			else 
				Status= false;
		}
	...
	public boolean verifySearchStartsWith(String description) throws Exception {
		...
		for (Map<String,String> map1: UI)
		{   	
			if(map1.get("Originator").toLowerCase().startsWith(description.toLowerCase()))
				Status= true;
			else 
				Status= false;
		}
	...
	public boolean verifySearchEndsWith(String description) throws Exception {
		...
		for (Map<String,String> map1: UI)
		{   	
			if(map1.get("Originator").toUpperCase().endsWith(description.toUpperCase()))
				Status= true;
			else 
				Status= false;
		}
	...
	public boolean groupby() {
		DragandDrop(originator,droptarget);
		try {
			Thread.sleep(5000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		if(groupby.getText().split(": ")[1].equals(groupbyOriginator.getText()))
		{return true;}
		else
			return false;		
	}
	...
	public boolean verifyExportToExcel(String filePath) {
		...
		for (final File f : folder.listFiles()) {
			if (f.getName().startsWith("OCMFaceAuthReport")) {
				f.delete();
			}
		}
		...
		Boolean Status=verifyExportPageFileDownload(filePath, "OCMFaceAuthReport");
		return Status;
	}
