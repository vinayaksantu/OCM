...
import com.tetherfi.pages.OCMAgentSurveyPerformanceReportPage;
...
public class OCMAgentSurveyPerformanceReportTest extends BaseTest {
	...
	public void ShowReport() throws Exception {
		String filePath = System.getProperty("user.dir")+"\\src\\test\\resources\\TestData\\OCMAgentSurveyPerformanceReport.xlsx";
	...
	public void OCMWindow() throws Exception {  	
		...
		OCMReportsPage ocmReportsPage=PageFactory.createPageInstance(driver,OCMReportsPage.class);
		ocmReportsPage.showReport(reportDetails);        
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);                   
		Assert.assertTrue(agentSurveyPerformancePage.maximizewindow(),"Fullscreen Assertion Failed"); 
		screenshot.captureScreen("RegDegReport","Maximize");
		Assert.assertTrue(agentSurveyPerformancePage.minimizewindow(), "Restored Assertion Failed");
	...
	public void VerifyDropdownForAllTheColumns() throws Exception {		
		...
		ocmReportsPage.showReport(reportDetails);	
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifyDropDownOfAllHeaders(), "Columns dropdown assertion failed");
	}   
	...
	public void VerifyColumnsHeaderEnable() throws Exception {
		...
		ocmReportsPage.showReport(reportDetails);		
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifycolumnsHeaderEnabled(),"columns enabled assertion failed");
	}  
	...
	public void VerifyColumnsHeaderDisable() throws Exception {
		...
		ocmReportsPage.showReport(reportDetails);
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertFalse(agentSurveyPerformancePage.verifycolumnsHeaderDisabled(),"columns disabled assertion failed");
	}  
	...
	public void VerifyArrowMoveForPreviousAndNextPage() throws Exception {  
		...
		ocmReportsPage.showReport(reportDetails);
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifyArrowMoveForPreviousAndNextPage(),"arrow move for previous and next page assertion failed");
	}   
	...
	public void VerifyArrowMoveForFirstAndLastPage() throws Exception {
		...
		ocmReportsPage.showReport(reportDetails);
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifyArrowMoveForFirstAndLastPage(),"arrow move for first and last page assertion failed");
	} 
	...
	public void VerifyTotalNumberOfItemsPerPageDetails() throws Exception {
		...
		ocmReportsPage.showReport(reportDetails);
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifyTotalNumberOfItemsPerPageDetails(),"item per page assertion failed");
	}   
	...
	public void VerifyNumberOfItemsPerPageSelection() throws Exception {
		...
		ocmReportsPage.showReport(reportDetails);
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifyNumberOfItemsPerPage(),"item per page assertion failed");
	}    
	...
	public void ExportPage() throws Exception{
		...
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifyExportToExcel(filePath1));
	}
	...
	public void VerifyExportedPage() throws Exception
	{
		...
		OCMReportsPage ocmReportsPage=PageFactory.createPageInstance(driver,OCMReportsPage.class);
		ocmReportsPage.showReport(reportDetails); 
		String filePath1 = System.getProperty("user.dir")+"\\src\\test\\resources\\DownloadedFiles\\OCMAgentSurveyPerformanceReport.xlsx";
		List<Map<String, String>> maplist = new ExcelReader(filePath1,"Sheet1").getTestData();
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifyexportToExcelSheet(maplist));
	}

	@Test(priority=27,description="Scheduled report button in report page")
	public void SchedulereportinAgentSurveyPerformanceReportPage() throws Exception {
		String filePath = System.getProperty("user.dir")+"\\src\\test\\resources\\TestData\\OCMAgentSurveyPerformanceReport.xlsx";
		Map<String, String> map = new ExcelReader(filePath,"ExportReport").getTestData().get(0);
		ReportDetails reportDetails= new ReportDetails(map);
		OCMReportsPage ocmReportsPage=PageFactory.createPageInstance(driver,OCMReportsPage.class);
		ocmReportsPage.showReport(reportDetails);            
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		agentSurveyPerformancePage.navigateToExportSchedulerPage();    
		Assert.assertTrue(agentSurveyPerformancePage.isExportSchedulerPageDisplayed(), "ExportScheduler page assertion failed");
		screenshot.captureScreen("AgentSurveyPerformanceReportTest","ExportSchedulerPage");
	}
	...
	public void ExportToExcel() throws Exception {
		...
		Assert.assertTrue(ocmReportsPage.verifyDateRangeReportDisplayedforSocialmedia(reportDetails),"Show report assertion failed");
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		agentSurveyPerformancePage.exportToExcel();
		Assert.assertTrue(agentSurveyPerformancePage.verifyReportExported(),"export report assertion failed");
	}
	@Test(priority=29,dependsOnMethods ="ExportToExcel")
	public void ViewDownloadedButtonInAgentSurveyPerformancePg() throws Exception {
		String filePath = System.getProperty("user.dir")+"\\src\\test\\resources\\TestData\\OCMAgentSurveyPerformanceReport.xlsx";
		Map<String, String> map = new ExcelReader(filePath,"ExportReport").getTestData().get(0);
		ReportDetails reportDetails= new ReportDetails(map);
		OCMReportsPage ocmReportsPage=PageFactory.createPageInstance(driver,OCMReportsPage.class);
		ocmReportsPage.showReport(reportDetails);  
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		agentSurveyPerformancePage.viewDownloadedReportInReportsDownloadsPage();
		Assert.assertTrue(ocmReportsPage.verifyDownloadedReportNameAndTimeInReportsDownloadPage(reportDetails.getReportName()),"Report not found in Reporter download page");   
	}      
	...
	public void VerifySearchByFeature() throws Exception {
		...
		Assert.assertTrue(ocmReportsPage.verifyDateRangeReportDisplayedforSocialmedia(reportDetails),"Show report assertion failed");
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifySearchByTextbox(reportDetails));
	}
	...
	public void VerifySearchFeatureForIsEqualTo() throws Exception {
		...
		Assert.assertTrue(ocmReportsPage.verifyDateRangeReportDisplayedforSocialmedia(reportDetails),"Show report assertion failed");
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifySearchIsEqualTo(reportDetails.getSearchStr()));				
	}
	...
	public void VerifySearchIsNotEqualTo() throws Exception {
		...
		ocmReportsPage.showReport(reportDetails);  
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifySearchIsNotEqualTo(reportDetails.getSearchStr()));
	}   
	...
	public void  VerifySearchContains() throws Exception {
		...
		ocmReportsPage.showReport(reportDetails);  
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifySearchContains(reportDetails.getSearchStr()));
	}   
	...
	public void  VerifySearchDoesNotContains() throws Exception {
		...
		ocmReportsPage.showReport(reportDetails);  
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifySearchDoesNotContains(reportDetails.getSearchStr())); 
	}  
	...
	public void  VerifySearchStartsWith() throws Exception {
		...
		ocmReportsPage.showReport(reportDetails);  
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifySearchStartsWith(reportDetails.getSearchStr()));
	}
	...
	public void  VerifySearchEndsWith() throws Exception {
		...
		ocmReportsPage.showReport(reportDetails);  
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifySearchEndsWith(reportDetails.getSearchStr()));
	}
	...
	public void searchwithoutSearchTextbox() throws Exception {
		...
		ocmReportsPage.showReport(reportDetails);
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		agentSurveyPerformancePage.searchwithoutextsearch(reportDetails);
		Assert.assertEquals(agentSurveyPerformancePage.getSuccessMessage(),"Please enter the text to search or remove the filter", "Add invalid record assertion failed");
	}
	...
	public void ClearSearch() throws Exception{
		...
		ocmReportsPage.showReport(reportDetails);  
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifySearchClear(reportDetails));    	
	} 	
	...
	public void verifyAdvancedSearchinreportpage() throws Exception {
		...
		ocmReportsPage.showReport(reportDetails);
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifyAdvanceSearchIsEqualTo(reportDetails));
	}
	...
	public void verifyAdvancedSearchANDCriteria() throws Exception {
		...
		Assert.assertTrue(agentSurveyPerformancePage.advancedSearchANDCriteria(reportDetails));   	
	}
	...
	public void verifyAdvancedSearchORCriteria() throws Exception {
		...
		OCMReportsPage ocmReportsPage=PageFactory.createPageInstance(driver,OCMReportsPage.class);                   	
		ocmReportsPage.chooseReport(reportDetails);
		Assert.assertTrue(agentSurveyPerformancePage.advancedSearchORCriteria(reportDetails));
	...
	public void GroupBy() throws Exception{
		...
		OCMReportsPage.showReport(reportDetails);
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.groupby());
		screenshot.captureScreen("AgentSurveyPerformancePage", "GroupBy");
		Assert.assertTrue(agentSurveyPerformancePage.groupby());
		screenshot.captureScreen("AgentSurveyPerformancePage", "AlreadyGroupBy");
	}
	...
	public void VerifySorting() throws Exception {
		...
		ocmReportsPage.showReport(reportDetails);
		OCMAgentSurveyPerformanceReportPage agentSurveyPerformancePage=PageFactory.createPageInstance(driver,OCMAgentSurveyPerformanceReportPage.class);
		Assert.assertTrue(agentSurveyPerformancePage.verifySorting(),"Sorting assertion failed");
	}
	
	@AfterMethod
	public void afterEachMethod(Method method) {
		Screenshot screenshot=new Screenshot(driver);
		screenshot.captureScreen("AgentSurveyPerformance", method.getName());
