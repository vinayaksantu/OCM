...
public class OCMEmailAgentPerformanceReportPage extends BasePage{

	public OCMEmailAgentPerformanceReportPage(WebDriver driver) {
		super(driver);}
	...
	public boolean verifySearchContains(String details) throws Exception {
		...
		for (Map<String,String> map1: UI)
		{   	
			if(map1.get("Agent ID").toUpperCase().contains(details.toUpperCase()))
				Status= true;
			else 
				Status= false;
		}
	...
	public boolean verifySearchDoesNotContains(String details) throws Exception {
		...
		for (Map<String,String> map1: UI)
		{   	
			if(!map1.get("Agent ID").toLowerCase().contains(details.toLowerCase()))
				Status= true;
			else 
				Status= false;
		}
	...
	public boolean verifySearchStartsWith(String details) throws Exception {
		...
		for (Map<String,String> map1: UI)
		{   	
			if(map1.get("Agent Name").toLowerCase().startsWith(details.toLowerCase()))
				Status= true;
			else 
				Status= false;
		}
	...
	public boolean verifySearchEndsWith(String details) throws Exception {
		...
		for (Map<String,String> map1: UI)
		{   	
			if(map1.get("Agent Name").toLowerCase().endsWith(details.toLowerCase()))
				Status= true;
			else 
				Status= false;
		}
	...
	public boolean verifyAdvancedSearchContains(ReportDetails details) throws Exception {
		...
		List<Map<String,String>>UI=getDataTable();
		for(Map<String,String> map1:UI){
			if(map1.get("Agent ID").contains(details.getSearchStr()))	
				Status= true;
			else 
				Status =false;
		}
	...
	public boolean verifyAdvancedSearchStartsWith(ReportDetails details) throws Exception {
		...
		for(Map<String,String> map1:UI){
			System.out.println(map1.get("Agent Name"));
			if(map1.get("Agent Name").startsWith(details.getSearchStr()))				
				Status= true;
			else 
				Status =false;
		}
	...
	public boolean verifyAdvancedSearchEndsWith(ReportDetails details) throws Exception {
		...
		for(Map<String,String> map1:UI){
			System.out.println(map1.get("Agent Name"));
			if(map1.get("Agent Name").toLowerCase().endsWith(details.getSearchStr().toLowerCase()))				
				Status= true;
			else 
				Status =false;
		}
	...
	public Boolean advancedSearchORCriteria(ReportDetails details) throws Exception {
		...
		List<Map<String,String>> UI=getDataTable(); 
		for (Map<String,String> map1: UI){   	
			if(map1.get("Agent Name").contains(details.getSearchStr()) || map1.get("Agent ID").equalsIgnoreCase(details.getSearchStr1()))
				Status= true;
			else 
				Status= false;
		}
	...
	public Boolean advancedSearchANDCriteria(ReportDetails details) throws Exception {
		...
		List<Map<String,String>> UI=getDataTable(); 
		for (Map<String,String> map1: UI){   	
			if(map1.get("Agent Name").equalsIgnoreCase(details.getSearchStr()) && map1.get("Agent ID").equalsIgnoreCase(details.getSearchStr1()))
				Status= true;
			else 
				Status= false;
		}
	...
	public boolean verifyExportToExcel(String filePath) {
		...
		for (final File f : folder.listFiles()) {
			if (f.getName().startsWith("EmailAgentPerformance")) {
				f.delete();
			}
		}
		...
		Boolean Status=verifyExportPageFileDownload(filePath, "EmailAgentPerformance");
		return Status;
	}
