...
public class AgentSettingsTest extends BaseTest{
	...
	public void VerifyAuditTrailReportForCreate() throws Exception {
		...
		Assert.assertTrue(ocmReportsPage.verifyAgentSettingsCreate(agentSettingsDetails, "Create"), "Audit Trail Report assertion failed");		
	}
	...
	public void VerifyDuplicateLanIDCreation() throws Exception {
		...
		AgentSettingsPageWMC agentSettingsPagewmc=PageFactory.createPageInstance(driver, AgentSettingsPageWMC.class);
		agentSettingsPagewmc.addNewAgentSettingsRecord(agentSettingsDetails);
		Assert.assertEquals(agentSettingsPagewmc.getSuccessMessage(),"Duplicate Lan ID", "Add Duplicate record assertion failed");
	}
	...
	Assert.assertFalse(agentSettingsPagewmc.verifyEditFormContainer(), "Cancel Button At Add Record Assertion Failed");	
}
	...
	public void VerifyCancelButtonAtEditRecord() throws Exception {
		...
		agentSettingsPagewmc.clickOnCancel();
		Assert.assertFalse(agentSettingsPagewmc.verifyEditFormContainer(), "Cancel Button At edit record Assertion failed");
		}
	...
	public void ExportToExcelData() throws Exception {
		 String filePath = System.getProperty("user.dir")+"\\src\\test\\resources\\DownloadedFiles\\AgentSettings.xlsx";
		 List<Map<String, String>> maplist = new ExcelReader(filePath,"Sheet1").getTestData();
		AgentSettingsPageWMC agentSettingsPagewmc=PageFactory.createPageInstance(driver, AgentSettingsPageWMC.class);
//		Assert.assertTrue(agentSettingsPagewmc.verifyExportToExcel());		
	}
	...
	public void verifyCancelButtonAtDeleteRecord() throws Exception {
		...
		Assert.assertFalse(agentSettingsPagewmc.verifyDeleteContainer(), "Delete Record Assertion Failed");
	}
