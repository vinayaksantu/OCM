...
public class OCMEventTraceReportPage extends BasePage {

	public OCMEventTraceReportPage(WebDriver driver) {
		super(driver);
	}
	...
	public boolean verifyExportToExcel(String filePath) {
		...
		Boolean Status=verifyExportPageFileDownload(filePath, "OCMTRSEventTraceReport");
		return Status;
	}
