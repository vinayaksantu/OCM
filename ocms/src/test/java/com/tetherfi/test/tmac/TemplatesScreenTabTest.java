...
public class TemplatesScreenTabTest extends BaseTest {
	...
	@Test(priority=3,description="To Verify Add New Screen Template without Screen")
	...
	@Test(priority=4,description="To Verify Add New Screen Template Window Close Button")
	public void VerifyAddNewScreenTemplateWindowCancelButton() throws Exception {
		AgentTemplatePage agentTemplatePage=PageFactory.createPageInstance(driver, AgentTemplatePage.class);
		Assert.assertTrue(agentTemplatePage.VerifyAddScreenTemplateWindowCancelButton(1), "CloseButton assertion Failed");
	}

	@Test(priority=5,description="To Verify Add New Screen Template with valid Data")
	...
	@Test(priority=6,description="To Verify 'Transfer all to' screen values")
	public void VerifyTransferAllToBtn() throws Exception {
		String filePath=System.getProperty("user.dir")+"\\src\\test\\resources\\TestData\\AgentTemplateData.xlsx";
		Map<String,String>map=new ExcelReader(filePath,"ScreenTab").getTestData().get(0);
		AgentTemplateDetails AgentTemplateDetails=new AgentTemplateDetails(map);
		AgentTemplatePage agentTemplatePage=PageFactory.createPageInstance(driver, AgentTemplatePage.class);
		agentTemplatePage.verifyTransferAllToBtn(AgentTemplateDetails,1);
		Assert.assertEquals(agentTemplatePage.VerifyMessage(), "Record inserted Successfully", "Screen Assertion Failed");
	}
	@Test(priority=7,description="To Verify 'Transfer all from' screen values")
	...
	public void VerifyCancelBtnatEditRecord() throws Exception {
		...
		AgentTemplateDetails AgentTemplateDetails=new AgentTemplateDetails(map);
		AgentTemplatePage agentTemplatePage=PageFactory.createPageInstance(driver, AgentTemplatePage.class);
		agentTemplatePage.editCancelScreenTab(AgentTemplateDetails,1);  
	...
	@Test(priority=15,description="To verify template screen UI data against DB")
