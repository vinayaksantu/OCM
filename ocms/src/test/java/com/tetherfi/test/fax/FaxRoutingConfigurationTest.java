...
public class FaxRoutingConfigurationTest extends BaseTest{
	...
	//@Test(dependsOnMethods= {"VerifyRouteFolder"},priority=8)
	...
	@Test(priority=16,dependsOnMethods = {"AddFaxRoutingConfigQueueRecord"})
	...
	@Test(priority=34)
	public void DeleteFaxRoutingConfigFolderRecord() throws Exception {
		String filePath = System.getProperty("user.dir") + "\\src\\test\\resources\\TestData\\FaxRoutingConfigData.xlsx";
	...
	@Test(dependsOnMethods = {"AddFaxRoutingConfigFolderRecord"},priority=35)
	...
	@Test(dependsOnMethods="EditFaxRoutingConfigRecord",priority=36)
