...
public class AgentTemplate_AuxCodeTab extends BaseTest {
	...
	public void VerifyAddNewAuxTemplateWindowCloseButton() throws Exception {
		AgentTemplatePage agentTemplatePage=PageFactory.createPageInstance(driver, AgentTemplatePage.class);
		Assert.assertTrue(agentTemplatePage.VerifyAddAuxTemplateWindowCloseButton(3), "CloseButton assertion Failed");
	}
	...
	public void VerifyTransferAllToBtn() throws Exception {
		...
		Assert.assertEquals(agentTemplatePage.VerifyMessage(), "Record inserted Successfully", "Transfer all Assertion Failed");
	}
	...
	public void VerifyTransferFromBtn() throws Exception {
		...
		Assert.assertEquals(agentTemplatePage.VerifyMessage(), "Record inserted Successfully","Transfer from Assertion Failed");
	}
	...
	public void VerifyCancelBtnatEditRecord() throws Exception {
		...
		AgentTemplateDetails AgentTemplateDetails=new AgentTemplateDetails(map);
		AgentTemplatePage agentTemplatePage=PageFactory.createPageInstance(driver, AgentTemplatePage.class);
		Assert.assertTrue(agentTemplatePage.editCancelAuxTab(AgentTemplateDetails,3),"Cancel Btn at Edit record assertion failed");  	 
	}
	//has defect PRDOCM-62997
