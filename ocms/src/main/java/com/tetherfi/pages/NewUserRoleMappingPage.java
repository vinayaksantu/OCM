...
public class NewUserRoleMappingPage extends BasePage {
    ...
    public boolean verifyRecordUpdated(){
    	...
    	public boolean ExporttoExcelWithoutData(UserRoleMappingDetails details) throws Exception {
    		searchUserRoleMappingRecord(details.getiCOMTemplateID());
    		waitForJqueryLoad(driver);
    		Thread.sleep(1000);
    		selectWebElement(exporttoexcel);
    	...
    	private void searchUserRoleMappingRecord(String iComTemplateID) throws Exception {
    		selectWebElement(searchLink);
            selectWebElement(selectSearchColumn.get(0));
    	...
    	public boolean verifyApprovedSectionData(UserRoleMappingDetails details) throws Exception {
    		searchUserRoleMappingRecordApprovedData(details.getiCOMTemplateID());
    	...
    	private void searchUserRoleMappingRecordApprovedData(String icomTemplateId) throws Exception {
    		selectWebElement(gridsearchLink);
            selectWebElement(selectSearchColumn.get(0));
            selectDropdownFromVisibleText(columnNameList,"ICOM Template ID");
            selectWebElement(selectSearchColumn.get(1));
    	...
    	public boolean verifyApprovedSectionDataafterapproval(UserRoleMappingDetails UserRoleMappingDetails) throws Exception {
    		searchUserRoleMappingRecordApprovedData(UserRoleMappingDetails.getiCOMTemplateID());
    		if(rowdata.getText().equals(UserRoleMappingDetails.getText()))
    			return true;
    		else
    		return false;
    	}
