...
public class EmailTemplatePage extends BasePage {
    ...
    private WebElement addNewEmailTemplateRecordBtn;
	...
	public boolean isEmailTemplatePageDisplayed() {
		waitForLoad(driver);
        waitForJqueryLoad(driver);
        return emailTemplate.isEnabled();
    }
    ...
    public boolean verifyDepartmentExportToExcel(String filePath) {
		...
		for (final File f : folder.listFiles()) {
		    if (f.getName().startsWith("EmailTemplate")) {
		        f.delete();
		    }
		}
		...
		Boolean Status=verifyExportPageFileDownload(filePath, "EmailTemplateDepartment");
		return Status;
	}
	...
	public boolean verifyGroupsExportToExcel(String filePath) {
		...
		Boolean Status=verifyExportPageFileDownload(filePath, "EmailTemplateGroup");
		return Status;
	}
	...
	public boolean verifyExportToExcel(String filePath) {
		...
		Boolean Status=verifyExportPageFileDownload(filePath, "EmailTemplate");
		return Status;
	}
	...
	public boolean DepartmentExporttoExcelWithoutData(EmailTemplateDetails details) throws Exception {
	...
	public boolean GroupExporttoExcelWithoutData(EmailTemplateDetails details) throws Exception {
	...
	public boolean ExporttoExcelWithoutData(EmailTemplateDetails details) throws Exception {
	...
	public void searchEmailTemplateRecord(String name) throws Exception  {
        selectWebElement(searchLink);
        selectWebElement(selectSearchColumn.get(0));
	...
	public boolean verifyinvalidDepartmentsearchwithwrongdata(EmailTemplateDetails EmailTemplateDetails) throws Exception {
		searchDepartmentRecord(EmailTemplateDetails.getDepartmentName());
		try {
			Thread.sleep(1000);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
	...
	public boolean verifyDepartmentclearsearch() {
		selectWebElement(clearsearch);
		if(departmentsGridContent.isDisplayed())
			return true;
		else
		return false;
	}
	public boolean verifyGroupclearsearch() {
		selectWebElement(clearsearch);
		if(groupsGridContent.isDisplayed())
			return true;
		else
		return false;
	}
	public boolean verifyinvalidGroupsearchwithwrongdata(EmailTemplateDetails EmailTemplateDetails) throws Exception {
		searchGroupRecord(EmailTemplateDetails.getGroupName());
		try {
			Thread.sleep(1000);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
	...
	public boolean verifyinvalidsearchwithwrongdata(EmailTemplateDetails EmailTemplateDetails) throws Exception {
		searchEmailTemplateRecord(EmailTemplateDetails.getTemplateName());
		try {
			Thread.sleep(1000);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
	...
	public boolean clearAll(EmailTemplateDetails EmailTemplateDetails) throws Exception {
		selectWebElement(searchLink);
        selectWebElement(selectSearchColumn.get(0));
        selectDropdownFromVisibleText(columnNameList,"Template Name");
        selectWebElement(selectSearchColumn.get(1));
        selectDropdownFromVisibleText(searchTypeList,"Is equal to");
        enterValueToTxtField(searchText.get(0),EmailTemplateDetails.getTemplateName());
	...
	public boolean GroupclearAll(EmailTemplateDetails EmailTemplateDetails) throws Exception {
		selectWebElement(searchLink);
        selectWebElement(selectSearchColumn.get(0));
        selectDropdownFromVisibleText(columnNameList,"Name");
        selectWebElement(selectSearchColumn.get(1));
        selectDropdownFromVisibleText(searchTypeList,"Is equal to");
        enterValueToTxtField(searchText.get(0),EmailTemplateDetails.getGroupName());
        selectWebElement(clearall);
		if(searchText.get(0).isEnabled())
        	return true;
        else
	...
	public boolean departmentclearAll(EmailTemplateDetails EmailTemplateDetails) throws Exception {
		selectWebElement(searchLink);
        selectWebElement(selectSearchColumn.get(0));
        selectDropdownFromVisibleText(columnNameList,"Name");
        selectWebElement(selectSearchColumn.get(1));
        selectDropdownFromVisibleText(searchTypeList,"Is equal to");
        enterValueToTxtField(searchText.get(0),EmailTemplateDetails.getDepartmentName());
        selectWebElement(clearall);
		if(searchText.get(0).isEnabled())
        	return true;
        else
	...
	public void searchwithoutextsearch() {
		selectWebElement(searchLink);
        selectWebElement(selectSearchColumn.get(0));
        selectDropdownFromVisibleText(columnNameList,"Enabled");
        selectWebElement(selectSearchColumn.get(1));
        selectDropdownFromVisibleText(searchTypeList,"Is equal to");
        selectWebElement(searchBtn);
		selectWebElement(searchClose);
	...
	public void addNewDepartmentRecord(EmailTemplateDetails details) throws Exception {
    ...
    public boolean isAddBtnDisplayed() {
    	return addNewEmailTemplateRecordBtn.isDisplayed() && addNewEmailTemplateRecordBtn.isEnabled();
    }
    ...
    public void addRecordWithoutEnabled(EmailTemplateDetails details) throws Exception {
		selectWebElement(addNewDepartmentRecordBtn);
		waitForJqueryLoad(driver);
        selectWebElement(nameTextbox);
        enterValueToTxtField(nameTextbox,details.getDepartmentName());
	...
	public void addRecordWithoutDepartment(EmailTemplateDetails details) throws Exception {
		selectWebElement(addNewDepartmentRecordBtn);
		waitForJqueryLoad(driver);
		Thread.sleep(1000);
        selectWebElement(enableDropdown);
	...
	public void addNewEmptyRecord(EmailTemplateDetails details) {
		selectWebElement(addNewDepartmentRecordBtn);
		waitForJqueryLoad(driver);
        selectWebElement(saveBtn);	
        selectWebElement(cancelBtn);
	...
	public boolean verifyDepartmentGrid() {
		 try {
	            Thread.sleep(3000);
	        } catch (InterruptedException e) {
	            e.printStackTrace();
	        }
	        return isElementExist(departmentsGridContent);
	}	
	
	public boolean verifyGroupGrid() {
		try {
            Thread.sleep(3000);
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
        return isElementExist(groupsGridContent);		
	}
	
	public boolean verifyEmailGrid() {
		try {
            Thread.sleep(3000);
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
        return isElementExist(gridContent);
	}
	
	public void addNewGroupRecord(EmailTemplateDetails details) throws Exception {
	...
	public void addRecordWithoutDepartmentName(EmailTemplateDetails details) throws Exception {
		selectWebElement(addNewGroupRecordBtn);
        waitForJqueryLoad(driver);
        waitUntilWebElementIsVisible(popupContent);
        try {
	...
	public void addRecordWithoutName(EmailTemplateDetails details) {
		selectWebElement(addNewGroupRecordBtn);
        waitForJqueryLoad(driver);
        waitUntilWebElementIsVisible(popupContent);
        try {
	...
	public void addRecordWithoutGroupEnabled(EmailTemplateDetails details) throws Exception {
		selectWebElement(addNewGroupRecordBtn);
        waitForJqueryLoad(driver);
        waitUntilWebElementIsVisible(popupContent);
        try {
	...
	public void addNewEmailTemplateRecord(EmailTemplateDetails details) throws Exception {
		selectWebElement(addNewEmailTemplateRecordBtn);
    	waitUntilWebElementIsVisible(popupContent);
        waitForJqueryLoad(driver);
        try {
            Thread.sleep(5000);
        ...
        selectWebElement(nameTextbox);
        enterValueToTxtField(nameTextbox,details.getTemplateName());
        enterValueToTxtField(subjectTextbox,details.getSubject());
        selectWebElement(enableDropdown);
        ...
        enterValueToTxtField(body,details.getBody());
	...
	public void addNewEmptyEmailTemplateRecord(EmailTemplateDetails EmailTemplatesDetails) {
		selectWebElement(addNewEmailTemplateRecordBtn);
        waitUntilWebElementIsVisible(popupContent);
        waitForJqueryLoad(driver);
        try {
	...
	public void addRecordWithoutEmailDepartmentName(EmailTemplateDetails details) throws Exception {
		selectWebElement(addNewEmailTemplateRecordBtn);
	    waitUntilWebElementIsVisible(popupContent);
		waitForJqueryLoad(driver);
		try {
	...
	public void addRecordWithoutGroupName(EmailTemplateDetails details) throws Exception {
	  	selectWebElement(addNewEmailTemplateRecordBtn);
        waitUntilWebElementIsVisible(popupContent);
        waitForJqueryLoad(driver);
        try {
	...
	public void addRecordWithoutSubject(EmailTemplateDetails details) throws Exception {
		selectWebElement(addNewEmailTemplateRecordBtn);
    	waitUntilWebElementIsVisible(popupContent);
        waitForJqueryLoad(driver);
        try {
	...
	public void addRecordWithoutEmailEnabled(EmailTemplateDetails details) throws Exception {
		selectWebElement(addNewEmailTemplateRecordBtn);
    	waitUntilWebElementIsVisible(popupContent);
        waitForJqueryLoad(driver);
        try {
	...
	public void addRecordWithoutType(EmailTemplateDetails details) throws Exception {
		selectWebElement(addNewEmailTemplateRecordBtn);
    	waitUntilWebElementIsVisible(popupContent);
        waitForJqueryLoad(driver);
        try {
	...
	public void addRecordWithoutBody(EmailTemplateDetails details) throws Exception {
		selectWebElement(addNewEmailTemplateRecordBtn);
    	waitUntilWebElementIsVisible(popupContent);
        waitForJqueryLoad(driver);
        try {
	...
	public void addRecordWithoutEmailName(EmailTemplateDetails details) throws Exception {
		selectWebElement(addNewEmailTemplateRecordBtn);
    	waitUntilWebElementIsVisible(popupContent);
        waitForJqueryLoad(driver);
        try {
	...
	public void addNewEmptyGroupRecord(EmailTemplateDetails EmailTemplatesDetails) {
		selectWebElement(addNewGroupRecordBtn);
        waitForJqueryLoad(driver);
        waitUntilWebElementIsVisible(popupContent);
        try {
	...
	/*
	    ...
	    public void deleteEmailTemplatesRecord(String name,String reason) throws Exception {
	        searchEmailTemplatesRecord(name);
	        btnClick(deleteBtn);
	    ...
	    public void editDepartmentRecord(EmailTemplateDetails details) throws Exception {
	        searchDepartmentRecord(details.getDepartmentName());
	        selectWebElement(editBtn);
	        waitForJqueryLoad(driver);
	        try {
	    ...
	    public void editGroupRecord(EmailTemplateDetails details) throws Exception {
	        searchGroupRecord(details.getGroupName());
	        selectWebElement(editBtn);
	        waitForJqueryLoad(driver);
	        waitUntilWebElementIsVisible(popupContent);
		...
		public boolean VerifyDepartmentDropdown(EmailTemplateDetails EmailTemplateDetails) {
			Boolean Status=false;
			selectWebElement(departmentNameDropdown);
			for(WebElement ele : departmentNameListbox) {
				if(ele.getText().equals(EmailTemplateDetails.getDepartmentName())) {
					Status=true;
					break;
				}
			}
			return Status;
				...
				public void editEmailDepartmentWithoutModifyReason(EmailTemplateDetails details) throws Exception {
					searchDepartmentRecord(details.getDepartmentName());
			        selectWebElement(editBtn);
			        waitForJqueryLoad(driver);
			        try {
				...
				public void editEmailTemplateGroupWithoutModifyReason(EmailTemplateDetails details) throws Exception {
					searchGroupRecord(details.getGroupName());
			        selectWebElement(editBtn);
			        waitForJqueryLoad(driver);
			        try {
				...
				public boolean VerifyGroupDropdown(EmailTemplateDetails details) throws Exception {
					Boolean Status=false;
					waitForJqueryLoad(driver);
			        waitUntilWebElementIsVisible(popupContent);
			        try {
				...
				public void deleteEmailTempalateWithoutDeleteReasonRecord(EmailTemplateDetails details) throws Exception {
					searchEmailTemplatesRecord(details.getName());
			        btnClick(deleteBtn);
			        selectWebElement(deleteReasonTextBox);
			        selectWebElement(yesBtn);
				}
				public void deleteGroupsWithoutDeleteReasonRecord(EmailTemplateDetails details) throws Exception {
					searchGroupRecord(details.getGroupName());
			        btnClick(deleteBtn);
			        selectWebElement(deleteReasonTextBox);
			        selectWebElement(yesBtn);
				...
				public void deleteDepartmentWithoutDeleteReasonRecord(EmailTemplateDetails details) throws Exception {
					searchDepartmentRecord(details.getDepartmentName());
			        btnClick(deleteBtn);
			        selectWebElement(deleteReasonTextBox);
			        selectWebElement(yesBtn);				
