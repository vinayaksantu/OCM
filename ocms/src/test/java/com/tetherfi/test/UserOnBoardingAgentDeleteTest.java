...
public class UserOnBoardingAgentDeleteTest {
	...
	@Test(groups = { "Maker" },priority=1,description="To Verify DeleteCancelUserOnBoardingRecord  ")
    public void DeleteCancelUserOnBoardingRecord() throws Exception {
        ...
        UserOnBoardingPage userOnBoardingPage = PageFactory.createPageInstance(driver, UserOnBoardingPage.class);
        Assert.assertTrue(userOnBoardingPage.deleteCancel(UserOnBoardingDetails), "delete record assertion failed");
    }
    
    @Test(groups = { "Maker" },priority=2,description="To Verify DeleteRecord to Revert ")
    ...
    @Test(groups = { "Maker" },priority=5,description="To Verify delete Record to Reject ")
    ...
    @Test(groups = { "Maker" },priority=6,dependsOnMethods="RejectDeleteRecord",description="To VerifySendForApprovalForDeleted NewRecord ")
    ...
    @Test(priority=7,groups = { "Checker" },dependsOnMethods="VerifySendForApprovalForDeleteNewRecord",description="to Verify RejectforDeleteUserOnBoardingRecord ")
    ...
    @Test(groups= {"Maker"},priority=9,description="To Verify DeleteUserOnBoardingRecord ")
    ...
    public void afterEachMethod(Method method){
        ...
        screenshot.captureScreen("UserOnBoardingAgentDeleteTest",method.getName());
        driver.navigate().refresh();
        HomePage homePage = PageFactory.createPageInstance(driver, HomePage.class);
        homePage.userLogout();
        driver.close();
