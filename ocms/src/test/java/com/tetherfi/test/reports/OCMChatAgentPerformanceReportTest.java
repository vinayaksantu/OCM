...
public class OCMChatAgentPerformanceReportTest extends BaseTest {
	...
	@Test(priority=7,dependsOnMethods ="ExportOCMChatAgentPerformanceReport")
	...
	@Test(priority=8,dependsOnMethods ="ViewDownloadedOcmChatAgentPerformanceReportInReportsDownloadPage",description="To verification of exported excel in Report downloads")
	...
	@Test(priority=9,description="To verify Show Report for Date Range")
	...
	@Test(priority=10,dependsOnMethods ="ShowOCMChatAgentPerformanceReportForDateRange",description="To verify Show Report for Date Range in New Tab")
	...
	@Test(priority=11,description="Export scheduler button")
	...
	@Test(priority=13,dependsOnMethods ="ExportOCMChatAgentPerformanceReportDateRange",description="To verification of exported excel in Report downloads for Date Range")
	...
	@Test(priority=14,dependsOnMethods ="ViewDownloadedOcmChatAgentPerformanceReportInReportsDownloadPageDateRange",description="To verification of exported excel in Report downloads")
	...
	@Test(priority=15,description="Delete record in Reports Download without Delete reason for date range")
	...
	@Test(priority=17,description="Delete Record at Reports download Button")
	...
	@Test(priority=18,description="Report page clear All button ")
	...
	@Test(priority=19,description="Maximize, minimize")
	...
	@Test(priority=20,description="Verify dropdown of all the coulnm headers")
	...
	@Test(priority=21,description="Verify column header Enable")
	...
	@Test(priority=22,description="Verify column header disable")
	...
	@Test(priority=23,description="Verify Pagination, Move to previous and next page")
	...
	@Test(priority=24,description="Verify Pagination, Move to First and Last Page")
	...
	@Test(priority=28,description="Scheduled report button in ChatAgentPerformance report page")
	...
	@Test(priority=29,description="Export to excel button in ChatAgentPerformance  Report page")
	...
	@Test(priority=30,dependsOnMethods ="ExportToExcelForChatAgentPerformanceReport",description="Verify the view Downloaded report in ChatAgentPerformance report page")
	...
	@Test(priority=31,dependsOnMethods ="ViewDownloadedOcmChatAgentPerformanceReportInReportsDownloadPageDateRange",description="To verification of exported excel in Report downloads")
	...
	@Test(priority=32,description="To Verify Ascending and Descending order")
	...
	@Test(priority=34,description="To Verify the search Is equal to criteria")
	...
	@Test(priority=43,description="Advance search on reports page for Is After Criteria")
	public void verifyAdvancedSearchSearchIsAfter() throws Exception {
		...
		OCMReportsPage OCMReportsPage=PageFactory.createPageInstance(driver,OCMReportsPage.class);  
		OCMChatAgentPerformanceReportPage OCMChatAgentPerformanceReportPage=PageFactory.createPageInstance(driver,OCMChatAgentPerformanceReportPage.class);
		OCMReportsPage.showReport1(reportDetails);
		Assert.assertTrue(OCMChatAgentPerformanceReportPage.verifyAdvanceSearchIsAfter(reportDetails));
	}

	@Test(priority=44,description="Advance search on reports page for Is Before Criteria")
	...
	@Test(priority=47,description="To Verify Drill DownGrid for Chat Transferred")
	...
	@Test(priority=48,description="To Verify Drill DownGrid for Chat Conferenced")
	...
	@Test(priority=49,description="Group By fuctionality")
    ...
    public void afterEachMethod(Method method) {
    	Screenshot screenshot=new Screenshot(driver);
    	screenshot.captureScreen("ChatAgentPerformance", method.getName());
