...
public class OCMAgentSurveyAverageReportPage extends BasePage  {

	public OCMAgentSurveyAverageReportPage(WebDriver driver) {
		super(driver);
	}
	...
	public boolean verifyExportToExcel(String filePath) {
		...
		for (final File f : folder.listFiles()) {
			if (f.getName().startsWith("OCMAgentSurveyAverageReport")) {
				f.delete();
			}
		}
		selectWebElement(exporttoexcel);
		...
		Boolean Status=verifyExportPageFileDownload(filePath, "OCMAgentSurveyAverageReport");
		return Status;
	}
