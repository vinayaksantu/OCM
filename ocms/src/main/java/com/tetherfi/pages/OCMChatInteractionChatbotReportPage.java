...
public class OCMChatInteractionChatbotReportPage extends BasePage  {

	public OCMChatInteractionChatbotReportPage(WebDriver driver) {
		super(driver);
	}
...
private WebElement groupbycolor;*/
	...
	public boolean verifyExportToExcel(String filePath) {
		...
		for (final File f : folder.listFiles()) {
			if (f.getName().startsWith("OCM Chat Interaction ChatBot Report")) {
				f.delete();
			}
		}
		selectWebElement(exporttoexcel);
		...
		Boolean Status=verifyExportPageFileDownload(filePath, "OCM Chat Interaction ChatBot Report");
		return Status;
	}
	...
	public boolean verifySearchByTextbox(ReportDetails details) throws Exception{	
		...
		searchbyfeatureTextBox.sendKeys("Palak Garg");
