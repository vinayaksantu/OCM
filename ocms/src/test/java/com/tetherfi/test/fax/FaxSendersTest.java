...
public class FaxSendersTest extends BaseTest {
   ...
   public void EditFaxSendersInvalidRecord() throws Exception {
    ...
    @Test(priority=13,dependsOnMethods = {"AddFaxSendersRecord"})
    ...
    @Test(dependsOnMethods = {"EditFaxSendersRecord"},priority=20)
    ...
    @Test(dependsOnMethods = {"AddFaxSendersRecord"},priority=40)
    ...
    @Test(dependsOnMethods="EditFaxSendersRecord",priority=41)
    ...
    @Test(priority=42,dependsOnMethods = {"DeleteFaxSendersRecord"})
