...
public class ExportSchedulerPage extends BasePage {
	...
	private WebElement exportSchedulerImg;
	...
	private WebElement groupbyFrequency;
	...
	@FindBy(css=".form-group .k-multiselect-wrap")
	private List<WebElement> ReportListDropdown;
	
	@FindBy(css=".form-group .k-multiselect-wrap #Address_taglist")
	private WebElement EmailDropdown;
	
	@FindBy(css="ul[id='Report_listbox'] li")
	private List<WebElement> ReportListbox;
	
	@FindBy(css="ul[id='Address_listbox'] li")
	private List<WebElement> EmailListbox;
	
	@FindBy(css="span[aria-owns='Frequency_listbox']")
	private WebElement FrequencyDropdown;
	
	@FindBy(css="ul[id='Frequency_listbox'] li")
	private List<WebElement> FrequencyListbox;
	
	@FindBy(css="span[aria-owns='Day_listbox']")
	...
	@FindBy(id="Time")
	private WebElement TimeTextbox;
    ...
    public boolean VerifyLogo() {
    	if(exportSchedulerImg.isDisplayed())
    		return true;
    	else
		return false;
	...
	public boolean verifyExportToExcel(String filePath) {
		...
		for (final File f : folder.listFiles()) {
		    if (f.getName().startsWith("Export Scheduler")) {
		        f.delete();
		    }
		}
		...
		Boolean Status=verifyExportPageFileDownload(filePath, "Export Scheduler");
		return Status;
	}
    ...
    public boolean groupby() {
		...
		if(groupby.getText().split(": ")[1].equals(groupbyFrequency.getText()))
		{return true;}
		else
			return false;		
	}
	public boolean clearAll(ExportSchedulerDetails exportSchedulerDetails) throws Exception {
	...
	public void addNewExportSchedulerRecordDaily(ExportSchedulerDetails details) throws Exception {
		...
		enterValueToTxtBox1(TimeTextbox,details.getTime());
        selectWebElement(saveButton);
	}
	
	public void addNewExportSchedulerRecordWeekly(ExportSchedulerDetails details) throws Exception {
		selectWebElement(addNewExportSchedulerRecordBtn);
		waitUntilWebElementIsVisible(NameTextbox);
		enterValueToTxtField(NameTextbox,details.getName());
		selectWebElement(ReportListDropdown.get(0));
        ...
        selectWebElement(FrequencyDropdown);
        selectDropdownFromVisibleText(FrequencyListbox,details.getFrequency());
        selectWebElement(DayDropdown);
        selectDropdownFromVisibleText(DayListbox,details.getDay());
		enterValueToTxtBox1(TimeTextbox,details.getTime());
        selectWebElement(saveButton);		
	}
	
	public void addNewExportSchedulerRecordMonthly(ExportSchedulerDetails details) throws Exception {
		selectWebElement(addNewExportSchedulerRecordBtn);
		waitUntilWebElementIsVisible(NameTextbox);
		enterValueToTxtField(NameTextbox,details.getName());
		selectWebElement(ReportListDropdown.get(0));
        ...
        selectWebElement(FrequencyDropdown);
        selectDropdownFromVisibleText(FrequencyListbox,details.getFrequency());
        selectWebElement(DateDropdown);
        selectDropdownFromVisibleText(DateListbox,details.getDate());
		enterValueToTxtBox1(TimeTextbox,details.getTime());
        selectWebElement(saveButton);				
	}
	
	public void addNewExportSchedulerRecordCustomDaily(ExportSchedulerDetails details) throws Exception {
		selectWebElement(addNewExportSchedulerRecordBtn);
		waitUntilWebElementIsVisible(NameTextbox);
		enterValueToTxtField(NameTextbox,details.getName());
		selectWebElement(ReportListDropdown.get(0));
        ...
        selectWebElement(FrequencyDropdown);
        selectDropdownFromVisibleText(FrequencyListbox,details.getFrequency());
		enterValueToTxtBox1(startTimeTextbox,details.getStartTime());
		enterValueToTxtBox1(TimeTextbox,details.getTime());
        selectWebElement(saveButton);		
	...
	public void editexportSchedulerRecord(ExportSchedulerDetails details) throws Exception {
		...
		Thread.sleep(3000);
		selectWebElement(ReportListDropdown.get(0));
        selectDropdownFromVisibleText(ReportListbox,details.getUpdatedReportList());
		enterValueToTxtFieldWithoutClear(ModifyReasonTextBox,details.getModifyReason());
		selectWebElement(saveButton);
	}
	
	public void searchexportScheduler(String name) throws Exception {
		selectWebElement(searchBtn);
        selectWebElement(selectSearchCol.get(0));
        selectDropdownFromVisibleText(columnNameList,"Name");
        selectWebElement(selectSearchCol.get(1));
	...
	public void editexportSchedulerRecordWithoutModifyReason(ExportSchedulerDetails details) throws Exception {
		searchexportScheduler(details.getName());
		waitUntilWebElementIsClickable(editButton);
		Thread.sleep(3000);
		selectWebElement(editButton);
		...
		selectWebElement(ReportListDropdown.get(0));
        selectDropdownFromVisibleText(ReportListbox,details.getUpdatedReportList());
		enterValueToTxtBox1(TimeTextbox,details.getUpdatedTime());
        selectWebElement(saveButton);	
        selectWebElement(cancelBtn);
	}
	...
	public void deleteExportSchedulerWithoutDeleteReasonRecord(ExportSchedulerDetails details) throws Exception {
		searchexportScheduler(details.getName());
		Thread.sleep(2000);
	...
	public void addNewRecordWithoutTime(ExportSchedulerDetails details) throws Exception {
		selectWebElement(addNewExportSchedulerRecordBtn);
		waitUntilWebElementIsVisible(NameTextbox);
		enterValueToTxtField(NameTextbox,details.getName());
		selectWebElement(ReportListDropdown.get(0));
	...
	public void addNewRecordWithoutEmail(ExportSchedulerDetails details) throws Exception {
		selectWebElement(addNewExportSchedulerRecordBtn);
		waitUntilWebElementIsVisible(NameTextbox);
		enterValueToTxtField(NameTextbox,details.getName());
		selectWebElement(ReportListDropdown.get(0));
	...
	public void addNewRecordWithoutFrequency(ExportSchedulerDetails details) throws Exception {
		selectWebElement(addNewExportSchedulerRecordBtn);
		waitUntilWebElementIsVisible(NameTextbox);
		enterValueToTxtField(NameTextbox,details.getName());
		selectWebElement(ReportListDropdown.get(0));
	...
	public void addNewRecordWithoutReport(ExportSchedulerDetails details) throws Exception {
		selectWebElement(addNewExportSchedulerRecordBtn);
		waitUntilWebElementIsVisible(NameTextbox);
		enterValueToTxtField(NameTextbox,details.getName());
        selectWebElement(ReportListDropdown.get(1));
	...
	public void addNewRecordWithoutDay(ExportSchedulerDetails details) throws Exception {
		selectWebElement(addNewExportSchedulerRecordBtn);
		waitUntilWebElementIsVisible(NameTextbox);
		enterValueToTxtField(NameTextbox,details.getName());
		selectWebElement(ReportListDropdown.get(0));
	...
	public void addNewRecordWithoutWeeklyTime(ExportSchedulerDetails details) throws Exception {
		selectWebElement(addNewExportSchedulerRecordBtn);
		waitUntilWebElementIsVisible(NameTextbox);
		enterValueToTxtField(NameTextbox,details.getName());
		selectWebElement(ReportListDropdown.get(0));
	...
	public void addNewRecordWithoutMonthlydate(ExportSchedulerDetails details) throws Exception {
		selectWebElement(addNewExportSchedulerRecordBtn);
		waitUntilWebElementIsVisible(NameTextbox);
		enterValueToTxtField(NameTextbox,details.getName());
		selectWebElement(ReportListDropdown.get(0));
	...
	public void addNewRecordWithoutMonthlyTime(ExportSchedulerDetails details) throws Exception {
		selectWebElement(addNewExportSchedulerRecordBtn);
		waitUntilWebElementIsVisible(NameTextbox);
		enterValueToTxtField(NameTextbox,details.getName());
		selectWebElement(ReportListDropdown.get(0));
	...
	public void addNewRecordWithoutStartTime(ExportSchedulerDetails details) throws Exception {
		selectWebElement(addNewExportSchedulerRecordBtn);
		waitUntilWebElementIsVisible(NameTextbox);
		enterValueToTxtField(NameTextbox,details.getName());
		selectWebElement(ReportListDropdown.get(0));
	...
	public void addNewRecordWithoutEndTime(ExportSchedulerDetails details) throws Exception {
		selectWebElement(addNewExportSchedulerRecordBtn);
		waitUntilWebElementIsVisible(NameTextbox);
		enterValueToTxtField(NameTextbox,details.getName());
		selectWebElement(ReportListDropdown.get(0));
