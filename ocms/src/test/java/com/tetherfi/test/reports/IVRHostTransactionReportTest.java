...
public class IVRHostTransactionReportTest extends BaseTest { 
...
public void NavigateToOcmReportsPage() {
    ...
    @Test(dependsOnMethods ="ExportIVRHostTransactionReport")
    public void ViewDownloadedIVRHostTransactionReportInNotificationPan() throws IOException {
        String filePath = System.getProperty("user.dir")+"\\src\\test\\resources\\TestData\\IVRHostTransactionReportData.xlsx";
        Map<String, String> map = new ExcelReader(filePath,"ExportReport").getTestData().get(0);
        ReportDetails reportDetails= new ReportDetails(map);
    ...
    @Test(dependsOnMethods ="ExportIVRHostTransactionReport")
    public void ViewDownloadedIVRHostTransactionReportInReportsDownloadPage() throws IOException {
        String filePath = System.getProperty("user.dir")+"\\src\\test\\resources\\TestData\\IVRHostTransactionReportData.xlsx";
        Map<String, String> map = new ExcelReader(filePath,"ExportReport").getTestData().get(0);
        ReportDetails reportDetails= new ReportDetails(map);
    ...
    @Test(dependsOnMethods ="ExportIVRHostTransactionReportDateRange")
    public void ViewDownloadedIVRHostTransactionReportInNotificationPanDateRange() throws IOException {
        String filePath = System.getProperty("user.dir")+"\\src\\test\\resources\\TestData\\IVRHostTransactionReportData.xlsx";
        Map<String, String> map = new ExcelReader(filePath,"ExportReportDateRange").getTestData().get(0);
        ReportDetails reportDetails= new ReportDetails(map);
    ...
    @Test(dependsOnMethods ="ExportIVRHostTransactionReportDateRange")
    public void ViewDownloadedIVRHostTransactionReportInReportsDownloadPageDateRange() throws IOException {
        String filePath = System.getProperty("user.dir")+"\\src\\test\\resources\\TestData\\IVRHostTransactionReportData.xlsx";
        Map<String, String> map = new ExcelReader(filePath,"ExportReportDateRange").getTestData().get(0);
        ReportDetails reportDetails= new ReportDetails(map);
