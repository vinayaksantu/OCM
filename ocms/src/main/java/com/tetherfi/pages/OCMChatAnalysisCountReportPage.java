...
public class OCMChatAnalysisCountReportPage extends BasePage  {

	public OCMChatAnalysisCountReportPage(WebDriver driver) {
		super(driver);
	}
	...
	public boolean verifyExportToExcel(String filePath) {
		...
		for (final File f : folder.listFiles()) {
			if (f.getName().startsWith("OCMChatAnalysisCountReport")) {
				f.delete();
			}
		}
		selectWebElement(exporttoexcel);
		...
		Boolean Status=verifyExportPageFileDownload(filePath, "OCMChatAnalysisCountReport");
		return Status;
	}
