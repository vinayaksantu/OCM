...
public class AgentTemplate_WidgetTab extends BaseTest{
	...
	@Test(priority=6,description="To Verify 'Transfer all to' selected Widget")
	...
	//has defect ProdOCM-62997,
	@Test(priority= 7,description="To Verify 'Transfer from' selected widget values")
	...
	//PRDOCM-66196 
	@Test(priority=8,description="To Verify 'Transfer all from' selected Widget")
