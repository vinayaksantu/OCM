...
public class VIPListManagementTest extends BaseTest{
	...
	public void VIPListManagementPage() {
    	...
    	screenshot.captureScreen("VIPListManagementTest","Maximize");
    	Assert.assertTrue(vipListMangementPage.minimizewindow(), "Restored Assertion Failed");
    	screenshot.captureScreen("VIPListManagementTest","Minimize");	
    }
   ...
   @Test(priority=6,dependsOnMethods = "AddNewVIPListRecord")
    ...
    @Test(priority=7,dependsOnMethods ="AddNewVIPListRecord",enabled=false)
   ...
   /* @Test(priority=20)
    ...
    @Test(priority=27,dependsOnMethods="EditVIPListRecord",enabled=false)
   ...
   /* @Test(priority=30)
    public void searchPage() throws Exception {
        ...
        screenshot.captureScreen("VIPListManagementTest", "clearall");
    ...
    @Test(priority=37,dependsOnMethods= {"DeleteVIPListRecord"},enabled=false)
