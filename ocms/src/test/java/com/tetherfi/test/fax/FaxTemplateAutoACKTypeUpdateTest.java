...
public class FaxTemplateAutoACKTypeUpdateTest {
...
protected WebDriver driver;
	...
	public void EditRevertAutoACKFaxTemplateRecord() throws Exception {
		...
		FaxTemplatePage faxTemplatePage=PageFactory.createPageInstance(driver, FaxTemplatePage.class);
		faxTemplatePage.EditAutoAckTemplateTypeRecord(faxTemplateDetails);
	...
	@Test(groups= {"Maker"},priority=3,dependsOnMethods="EditRevertAutoACKFaxTemplateRecord")
	...
	public void EditRejectAutoACKFaxTemplateRecord() throws Exception {
		String filePath=System.getProperty("user.dir")+"\\src\\test\\resources\\TestData\\FaxTemplateData.xlsx";
		Map<String, String> map=new ExcelReader(filePath,"Edit").getTestData().get(0);
		FaxTemplateDetails faxTemplateDetails=new FaxTemplateDetails(map);
		FaxTemplatePage faxTemplatePage=PageFactory.createPageInstance(driver, FaxTemplatePage.class);
	...
	@Test(groups= {"Maker"},priority=5,dependsOnMethods="EditRejectAutoACKFaxTemplateRecord")
	...
	@Test(groups= {"Checker"},priority=6,dependsOnMethods="VerifySendForApprovalForEditRejectRecord")
	...
	@Test(groups= {"Checker"},priority=7,dependsOnMethods="RejectforEditFaxTemplateRecord")
	...
	public void EditApproveAutoACKFaxTemplateRecord() throws Exception {
		String filePath=System.getProperty("user.dir")+"\\src\\test\\resources\\TestData\\FaxTemplateData.xlsx";
		Map<String, String> map=new ExcelReader(filePath,"Edit").getTestData().get(0);
		FaxTemplateDetails faxTemplateDetails=new FaxTemplateDetails(map);
		FaxTemplatePage faxTemplatePage=PageFactory.createPageInstance(driver, FaxTemplatePage.class);
	...
	@Test(groups= {"Maker"},priority=9,dependsOnMethods="EditApproveAutoACKFaxTemplateRecord")
	...
	@Test(groups= {"Maker"},priority=10,dependsOnMethods="EditApproveAutoACKFaxTemplateRecord")
	...
	@Test(groups= {"Maker"},priority=11)//,dependsOnMethods="VerifyAuditTrailReportForUpdate")
	...
	@Test(groups= {"Maker"},priority=12,dependsOnMethods="VerifySendForApprovalForEditApproveRecord")
	...
	@Test(groups= {"Checker"},priority=14,dependsOnMethods="ApproveForUpdatedFaxTemplateRecord")
	...
	public void EditApproveFaxTemplateRecordWithOutModifyReson() throws Exception {
		...
		FaxTemplateDetails faxTemplateDetails=new FaxTemplateDetails(map);
		FaxTemplatePage faxTemplatePage=PageFactory.createPageInstance(driver, FaxTemplatePage.class);
		faxTemplatePage.EditAutoAckTemplateTypeRecordWithOutModifyReason(faxTemplateDetails);
