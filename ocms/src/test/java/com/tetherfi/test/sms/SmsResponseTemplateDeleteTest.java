...
public class SmsResponseTemplateDeleteTest {
    ...
    public void VerifyTaskCompleteActionForDeleteRecord() throws Exception {
	     ...
	     SmsResponseTemplatePage.taskCompleteAction("Task Complete for Delete");
    ...
    @Test(priority=6,groups = { "Checker" },dependsOnMethods = "RejectforDeleteSmsResponseTemplateRecord")
	...
	@Test(priority=8,groups= {"Maker"},dependsOnMethods="DeleteSmsResponseTemplateRecord")
	...
	@Test(priority=9,groups = { "Maker" },dependsOnMethods="DeleteSmsResponseTemplateRecord")
	...
	@Test(priority=10,groups = { "Maker" },dependsOnMethods="VerifyAuditTrailDataForDeleteSmsResponseTemplateRecord")
    public void VerifyTaskCompleteActionForDeleteSmsResponseTemplateRecord() throws Exception {
	     SmsResponseTemplatePage SmsResponseTemplatePage = PageFactory.createPageInstance(driver, SmsResponseTemplatePage.class);
	     SmsResponseTemplatePage.selectSmsResponseTemplateAuditTrailTab();
	     SmsResponseTemplatePage.taskCompleteAction("Task Complete for Delete");
	     Assert.assertTrue(SmsResponseTemplatePage.verifyTaskCompleteSuccessMessage(),"Task Complete record assertion failed");
	...
	@Test(priority=11,groups = { "Checker" },dependsOnMethods="VerifyTaskCompleteActionForDeleteSmsResponseTemplateRecord")
	...
	@Test(priority=12,groups = { "Checker" },dependsOnMethods = "ApproveforDeleteSmsResponseTemplateRecord")
