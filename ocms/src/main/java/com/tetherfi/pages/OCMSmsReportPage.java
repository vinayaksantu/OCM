		...
		public class OCMSmsReportPage extends BasePage  {
			
			  public OCMSmsReportPage(WebDriver driver) {
			        super(driver);
			    }
...
private WebElement exportschedulerlinkonHomepg;
		...
		public boolean verifyExportToExcel(String filePath) {
			...
			for (final File f : folder.listFiles()) {
			    if (f.getName().startsWith("OCMSMSReport")) {
		        f.delete();
		    }
		}
		selectWebElement(exporttoexcel);
		...
		Boolean Status=verifyExportPageFileDownload(filePath, "OCMSMSReport");
			return Status;
		}
		    ...
		    selectWebElement(schRptsinAgent);
			 ...
			 private List<Map<String, String>> getDataTable() {
				...
				public boolean verifySearchByTextbox(ReportDetails details) throws Exception{	
				 ...
				 searchbyfeatureTextBox.sendKeys("CIFMurali");//given a session id value 
