...
public class CallBackAnnouncementTest extends BaseTest {
   ...
   /* @Test(priority=12)
    ...
    @Test(priority=23,dependsOnMethods = {"DeleteWithoutDeleteReasonRecord"})
    ...
    @Test(priority=37,dependsOnMethods ="AddNewCallbackAnnouncementRecord",enabled=true)
    ...
    @Test(priority=38,enabled=true)//,dependsOnMethods="EditCallBackAnnouncementRecord")
    ...
    @Test(dependsOnMethods= {"DeleteCallbackAnnouncementRecord"},priority=39,enabled=true)
