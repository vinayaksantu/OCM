...
public class OCMViolationRejectionReportPage extends BasePage {

	public OCMViolationRejectionReportPage(WebDriver driver) {super(driver);}
	...
	private WebElement groupbyEventName;
	...
	public boolean verifyAdvanceSearchIsEqualTo(ReportDetails reportDetails) throws Exception {
		...
		for(Map<String,String> map1:UI)
		{
			...
			if(map1.get("Event Name").equalsIgnoreCase(reportDetails.getSearchStr()))
				Status= true;
			else 
				Status =false;
		}
	...
	public boolean verifyAdvanceSearchContains(ReportDetails reportDetails) throws Exception {
		...
		for(Map<String,String> map1:UI)
		{
			...
			if(map1.get("Org. Unit").toLowerCase().contains(reportDetails.getSearchStr()))				
				Status= true;
			else 
				Status =false;
		}
	...
	public boolean verifyAdvanceSearchDoesNotContains(ReportDetails reportDetails) throws Exception {
		...
		{
			System.out.println(map1.get("Event Name"));
			if(!map1.get("Event Name").toUpperCase().contains(reportDetails.getSearchStr()))				
				Status= true;
			else 
				Status =false;
		}
	...
	public boolean verifyAdvanceSearchStartsWith(ReportDetails reportDetails) throws Exception {
		...
		{
			System.out.println(map1.get("Event Name"));
			if(!map1.get("Event Name").toLowerCase().startsWith(reportDetails.getSearchStr()))				
				Status= true;
			else 
				Status =false;
		}
	...
	public boolean verifyAdvanceSearchEndsWith(ReportDetails reportDetails) throws Exception {
		...
		{
			System.out.println(map1.get("Event Name"));
			if(!map1.get("Event Name").toLowerCase().endsWith(reportDetails.getSearchStr()))				
				Status= true;
			else 
				Status =false;
		}
	...
	public Boolean advancedSearchANDCriteria(ReportDetails details) throws Exception {
		...
		Thread.sleep(2000);
		selectDropdownFromVisibleText(searchColListBoxAdvSrchReportPage,"Event Name");
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		selectDropdownFromVisibleText(searchColListBoxAdvSrchReportPage1,"Org. Unit");
		Thread.sleep(2000);
	...
	public Boolean advancedSearchORCriteria(ReportDetails details) throws Exception {
		...
		selectWebElement(searchColDropdownAdvSrchReportPage1);
		Thread.sleep(2000);
		selectDropdownFromVisibleText(searchColListBoxAdvSrchReportPage1,"Total Inference");
		Thread.sleep(2000);
		selectWebElement(searchCriteriaDropdownAdvSrch1);
	...
	public boolean verifySearchContains(String description) throws Exception {
		...
		for (Map<String,String> map1: UI)
		{   	
			if(map1.get("Event Name").toUpperCase().contains(description.toUpperCase()))
				Status= true;
			else 
				Status= false;
		}
	...
	public boolean verifySearchDoesNotContains(String description) throws Exception {
		...
		for (Map<String,String> map1: UI)
		{   	
			if(!map1.get("Event Name").toLowerCase().contains(description.toLowerCase()))
				Status= true;
			else 
				Status= false;
		}
	...
	public boolean verifySearchStartsWith(String description) throws Exception {
		...
		for (Map<String,String> map1: UI)
		{   	
			if(map1.get("Event Name").toLowerCase().startsWith(description.toLowerCase()))
				Status= true;
			else 
				Status= false;
		}
	...
	public boolean verifySearchEndsWith(String description) throws Exception {
		...
		for (Map<String,String> map1: UI)
		{   	
			if(map1.get("Event Name").toUpperCase().endsWith(description.toUpperCase()))
				Status= true;
			else 
				Status= false;
		}
	...
	public boolean groupby() {
		DragandDrop(eventName,droptarget);
		try {
			Thread.sleep(5000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		if(groupby.getText().split(": ")[1].equals(groupbyEventName.getText()))
		{return true;}
		else
			return false;		
	}
	...
	public boolean verifyExportToExcel(String filePath) {
		...
		for (final File f : folder.listFiles()) {
			if (f.getName().startsWith("OCMViolationAccuracyReport")) {
				f.delete();
			}
		}
		...
		Boolean Status=verifyExportPageFileDownload(filePath, "OCMViolationAccuracyReport");
		return Status;
	}
