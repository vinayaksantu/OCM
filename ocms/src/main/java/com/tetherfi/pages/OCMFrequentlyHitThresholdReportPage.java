...
public class OCMFrequentlyHitThresholdReportPage extends BasePage  {

	public OCMFrequentlyHitThresholdReportPage(WebDriver driver) {
		super(driver);
	}
	...
	public Boolean advancedSearchANDCriteria(ReportDetails details) throws Exception {
		...
		Thread.sleep(2000);
		selectDropdownFromVisibleText(searchColListBoxAdvSrchReportPage1,"Agent Login Id");
		Thread.sleep(2000);
		selectWebElement(searchCriteriaDropdownAdvSrch1);
		selectDropdownFromVisibleText(searchCriteriaListboxAdvSrch1,"Is not equal to");
	...
	public boolean verifyDatabaseDrillGridOne(String queryDrillGridOne,ReportDetails details, String AgentName) throws Exception {
	...
	private List<Map<String, String>> getDataTableDrillGridOne1() throws Exception {
