...
public class TemplatesTemplateTabTest extends BaseTest {
	...
	@Test(priority=4)//,dependsOnMethods="AddnewtemplateRecord")
	public void verifyAuditTrailReportForCreate() throws Exception {
		...
		Assert.assertTrue(ocmReportsPage.verifyTemplateTabCreate(AgentTemplateDetails, "Create"), "Create Audit Trail Assertion Failed"); 
	}

	@Test(priority=5,description="Verify the Add new record Without org unit")
	...
	@Test(priority=7,description="Verify the Add new record Without Template name")
	...
	@Test(priority=8,description="Verify the save button at Add new template record")
	...
	@Test(priority=10)//,dependsOnMethods="AddnewtemplateRecord")
	...
	@Test(priority=13,description="verify the delete button without delete reason")
	...
	@Test(priority=14,description="verify the cancel button at delete record")
	public void VerifyCancelBtnatDeleteRecord() throws Exception {
		String filePath = System.getProperty("user.dir") + "\\src\\test\\resources\\TestData\\AgentTemplateData.xlsx";
		Map<String, String> map = new ExcelReader(filePath,"TemplateTab").getTestData().get(1);
		AgentTemplateDetails AgentTemplateDetails=new AgentTemplateDetails(map);
		AgentTemplatePage agentTemplatePage=PageFactory.createPageInstance(driver, AgentTemplatePage.class);
		Assert.assertTrue(agentTemplatePage.DeleteCancelTemplateTab(AgentTemplateDetails,0),"DeletecancelAssertion Failed");
	}

	@Test(priority=15,description="verify the delete button")
	...
	@Test(priority=16)//,dependsOnMethods="AddnewtemplateRecord")
	public void verifyAuditTrailReportForDelete() throws Exception {
		...
		ReportDetails reportDetails= new ReportDetails(map2);
		ocmReportsPage.showReport(reportDetails);
		Assert.assertTrue(ocmReportsPage.verifyTemplateTabDelete(AgentTemplateDetails, "Delete"), "Create Audit Trail Assertion Failed"); 
	}
