...
public class FaxTemplateAutoACKTypeCreateTest {
...
@Test(groups= {"Maker"},priority=1)
	public void AddAutoACKTemplateTypetoRevertRecord() throws Exception {
		...
		FaxTemplatePage faxTemplatePage=PageFactory.createPageInstance(driver,FaxTemplatePage.class );
		faxTemplatePage.addAutoACKTypeFaxTemplateRecord(faxTemplateDetails);
		Assert.assertEquals(faxTemplatePage.getSuccessMessage(), "Record Created Successfully");		
	}
	
	@Test(groups= {"Maker"},priority=2)//,dependsOnMethods="AddRevertRecord")
	...
	@Test(groups= {"Maker"},priority=6)//,dependsOnMethods="AddRejectRecord")
	...
	@Test(groups= {"Checker"},priority=7,dependsOnMethods="VerifySendForApprovalAddNewRecord")
	...
	@Test(groups= {"Checker"},priority=8,dependsOnMethods="RejectForAddNewFaxTemplateRecord")
	...
	@Test(groups= {"Maker"},priority=9)//,dependsOnMethods="VerifyAuditTrailReportForRejectRecord")
	...
	@Test(groups= {"Maker"},priority=11)//,dependsOnMethods="addApproveRecord")
	...
	@Test(groups= {"Maker"},priority=12,dependsOnMethods="VerifyAuditTrailReportForApproveRecord")
	...
	@Test(groups= {"Maker"},priority=14,dependsOnMethods="VerifySendForApprovalAddNewApproveRecord")
	...
	@Test(groups= {"Checker"},priority=16,dependsOnMethods="ApproveForAddNewFaxTemplateRecord")
	...
	@Test(groups= {"Checker"},priority=17)//,dependsOnMethods="VerifyAuditTrailReportForApprove")
	...
	@Test(groups= {"Maker"},priority=18,dependsOnMethods="VerifyApprovedDataSectionAfterApproval")
